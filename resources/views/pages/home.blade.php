    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
                    <div class="w-20 h-20 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform float-animation">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Qualidade Garantida</h3>
                    <p class="text-gray-600 leading-relaxed">Produtos de alta qualidade com garantia de satisfação e durabilidade</p>
                </div>

                <div class="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2" style="animation-delay: 0.1s">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform float-animation">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Entrega Rápida</h3>
                    <p class="text-gray-600 leading-relaxed">Prazos competitivos e entrega ágil para atender sua necessidade</p>
                </div>

                <div class="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2" style="animation-delay: 0.2s">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform float-animation">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-600 leading-relaxed">Equipe especializada pronta para ajudar em sua escolha</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://wa.me/5511999999999" target="_blank" class="px-10 py-5 bg-green-500 text-white rounded-xl font-bold hover:bg-green-600 hover:shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-3">
